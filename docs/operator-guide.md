...
There is **no hosted UniSchema SaaS yet**. v0.4.0 expects you to run the container or Node process yourself.
...
**Pilot (v0.4.0):** SQLite at `DATABASE_URL` + local/S3 egress files.
